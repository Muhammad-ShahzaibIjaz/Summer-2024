...
document.addEventListener('DOMContentLoaded', () => {
    let countrySelectionDiv = document.querySelector('.countrySelection');
    const optionList = countrySelectionDiv.querySelector('.countryOption');
    ...
    if(countrySelectionDiv){
        countries.forEach((country) => {
            let optionItem = document.createElement('li');
            optionItem.textContent = country.name;
